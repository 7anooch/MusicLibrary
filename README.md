...
You will also need https://github.com/dbeley/rymscraper as well as lastfm and spotify API keys, add them to the keys.json (and get rid of the '\_template' part). When setting up your spotify API key, make sure you set redirect uri to `http://localhost:8080/callback`.
